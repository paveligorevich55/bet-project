                        ...
                        <div class="flex flex-wrap -mx-3 sm:col-span-2">
                            <div class="w-6/12 max-w-full px-3 flex-0">
                                ...
                                <div class="relative flex flex-wrap items-stretch w-full rounded-lg">
                                    <input value="{{Auth::user()->name}}" type="text" name="First Name" placeholder="Alec" class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                                </div>
                            </div>
                        </div>
