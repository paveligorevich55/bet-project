...
<body class="m-0 font-sans text-base antialiased font-normal text-left leading-default dark:bg-slate-950 bg-gray-50 text-slate-500 dark:text-white">
    ...
    <div class="items-center block w-full h-auto grow basis-full" id="sidenav-collapse-main">
        ...
        <ul class="flex flex-col pl-0 mb-0 list-none">
            ...
            <li class="mt-0.5 w-full">
                <!-- primary anchor  -->
                <a active_primary collapse_trigger="primary" href="{{route('dashboard')}}" class="@if(Route::is('dashboard')) xl:shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 @endif ease-soft-in-out text-sm py-2.7 active  my-0 mx-4 flex items-center whitespace-nowrap   px-4   transition-all dark:text-white dark:opacity-80" aria-expanded="true">
                    <!-- big anchor expandable -->
                    <div class="@if(Route::is('dashboard')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif stroke-none shadow-soft-sm mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-black">
                        <!-- icon -->
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft text-slate-700">{{__('Dashboards')}}</span>
                </a>
            ...
            <li class="mt-0.5 w-full">
                <a collapse_trigger="primary" href="{{route('post.index')}}" class="@if(Route::is('post.index')) xl:shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 @endif ease-soft-in-out text-sm py-2.7 active my-0 mx-4 flex items-center whitespace-nowrap px-4 font-medium text-slate-500 shadow-none transition-colors dark:text-white" aria-controls="pagesExamples" role="button" aria-expanded="false">
                    <div class="@if(Route::is('post', 'post.index', 'post.create', 'post.show', 'post.edit')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif stroke-none shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-black">
                        @if(Route::is('post', 'post.index', 'post.create', 'post.show', 'post.edit'))
                                    ...
                                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                        <g transform="translate(1716.000000, 291.000000)">
                                            <g id="office" transform="translate(153.000000, 2.000000)">
                                                <path class="" d="M12.25,17.5 L8.75,17.5 L8.75,1.75 C8.75,0.78225 9.53225,0 10.5,0 L31.5,0 C32.46775,0 33.25,0.78225 33.25,1.75 L33.25,12.25 L29.75,12.25 L29.75,3.5 L12.25,3.5 L12.25,17.5 Z" opacity="0.6"></path>
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">{{__('Posts')}}</span>
                </a>
            </li>
            ...
            <li class="mt-0.5 w-full">
                <a collapse_trigger="primary" href="{{route('category.index')}}" class="@if(Route::is('category.index')) xl:shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 @endif ease-soft-in-out text-sm py-2.7 active  my-0 mx-4 flex items-center whitespace-nowrap px-4 font-medium text-slate-500 shadow-none transition-colors dark:text-white dark:opacity-80 dark:after:text-white/50 dark:after:text-white" aria-controls="applicationsExamples" role="button" aria-expanded="false">
                    <div class="@if(Route::is('category', 'category.index', 'category.create', 'category.show', 'category.edit')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif stroke-none shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-black">
                        @if(Route::is('category', 'category.index', 'category.create', 'category.show', 'category.edit'))
            ...
            <li class="mt-0.5 w-full">
                <a collapse_trigger="primary" href="{{route('promo.index')}}" class="@if(Route::is('promo.index')) xl:shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 @endif ease-soft-in-out text-sm py-2.7 active my-0 mx-4 flex items-center whitespace-nowrap px-4 font-medium text-slate-500 shadow-none transition-colors dark:text-white dark:opacity-80 " aria-controls="ecommerceExamples" role="button" aria-expanded="false">
                    <div class="@if(Route::is('promo', 'promo.index', 'promo.create', 'promo.show', 'promo.edit')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif stroke-none shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-black">
                        @if(Route::is('promo', 'promo.index', 'promo.create', 'promo.show', 'promo.edit'))
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">{{__('Promo Codes')}}</span>
                </a>
            </li>
            ...
            <li class="mt-0.5 w-full">
                <a collapse_trigger="primary" href="{{route('webmaster')}}" class="@if(Route::is('webmaster')) xl:shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 @endif ease-soft-in-out text-sm py-2.7 active my-0 mx-4 flex items-center whitespace-nowrap px-4 font-medium text-slate-500 shadow-none transition-colors dark:text-white dark:opacity-80 " aria-controls="ecommerceExamples" role="button" aria-expanded="false">
                    <div class="@if(Route::is('webmaster')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif stroke-none shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-black">
                        @if(Route::is('webmaster'))
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>box-3d-50</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-2319.000000, -291.000000)" fill="#FFFFFF" fill-rule="nonzero">
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">{{__('Webmaster Code')}}</span>
                </a>
            </li>

            <li class="mt-0.5 w-full">
                <a collapse_trigger="primary" href="{{route('link.index')}}" class="@if(Route::is('link.index')) xl:shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 @endif ease-soft-in-out text-sm py-2.7 active my-0 mx-4 flex items-center whitespace-nowrap px-4 font-medium text-slate-500 shadow-none transition-colors dark:text-white dark:opacity-80" aria-controls="authExamples" role="button" aria-expanded="false">
                    <div class="@if(Route::is('link', 'link.index', 'link.create', 'link.show', 'link.edit')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif stroke-none shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-black">
                        @if(Route::is('link', 'link.index', 'link.create', 'link.show', 'link.edit'))
                            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>settings</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF" fill-rule="nonzero">
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">{{__('Links')}}</span>
                </a>
            </li>
            {{--     Settings       --}}
            <li class="mt-0.5 w-full">
                <a collapse_trigger="primary" href="{{route('settings')}}" class="@if(Route::is('settings')) xl:shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 @endif ease-soft-in-out text-sm py-2.7 active my-0 mx-4 flex items-center whitespace-nowrap px-4 font-medium text-slate-500 shadow-none transition-colors dark:text-white dark:opacity-80" aria-controls="authExamples" role="button" aria-expanded="false">
                    <div class="@if(Route::is('settings')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif stroke-none shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-black">
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">{{__('Settings')}}</span>
                </a>
            </li>

            <li class="mt-0.5 w-full">
                <a collapse_trigger="primary" href="{{route('bookmaker.index')}}" class="@if(Route::is('bookmaker.index')) xl:shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 @endif ease-soft-in-out text-sm py-2.7 active my-0 mx-4 flex items-center whitespace-nowrap px-4 font-medium text-slate-500 shadow-none transition-colors dark:text-white dark:opacity-80" aria-controls="authExamples" role="button" aria-expanded="false">
                    <div class="@if(Route::is('bookmaker', 'bookmaker.index', 'bookmaker.create', 'bookmaker.show', 'bookmaker.edit')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif stroke-none shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-black">
                        @if(Route::is('bookmaker', 'bookmaker.index', 'bookmaker.create', 'bookmaker.show', 'bookmaker.edit'))
                            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>settings</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF" fill-rule="nonzero">
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">{{__('Bookmakers')}}</span>
                </a>
            </li>
    ...
    <main class="relative h-full max-h-screen transition-all duration-200 ease-soft-in-out xl:ml-68 rounded-xl">
        ...
        <div class="w-full px-6 mx-auto">
            ...
            @if(!Route::is('dashboard'))
                <div class="min-h-75 relative mt-6 flex items-center overflow-hidden rounded-2xl bg-[url('../../public/assets/img/curved-images/curved0.jpg')] bg-cover bg-center p-0">
