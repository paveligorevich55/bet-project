...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
        <div class="h-19.5">
            ...
            <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:void(0);" target="_blank">
                <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">{{ config('app.name', 'Dashboard') }}</span>
            </a>
        </div>
        ...
        <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                <li class="mt-0.5 w-full" aside-nav-items>
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap   px-4 transition-colors @if(Route::is('dashboard')) shadow-soft-xl rounded-lg bg-whitefont-semibold text-slate-700 @endif" href="{{ route('dashboard') }}">
                        <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5 @if(Route::is('dashboard')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif">
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors @if(Route::is('post', 'post.index', 'post.create', 'post.show', 'post.edit')) shadow-soft-xl rounded-lg bg-whitefont-semibold text-slate-700 @endif" href="{{ route('post.index') }}" aside-nav-link>
                        <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5 @if(Route::is('post', 'post.index', 'post.create', 'post.show', 'post.edit')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif">
                ...
                <li class="mt-0.5 w-full">
                    <a aside-nav-link class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors @if(Route::is('category', 'category.index', 'category.create', 'category.show', 'category.edit')) shadow-soft-xl rounded-lg bg-whitefont-semibold text-slate-700 @endif" href="{{ route('category.index') }}">
                        <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5 @if(Route::is('category', 'category.index', 'category.create', 'category.show', 'category.edit')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif">
                ...
                <li class="mt-0.5 w-full">
                    <a aside-nav-link class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors @if(Route::is('promo', 'promo.index', 'promo.create', 'promo.show', 'promo.edit')) shadow-soft-xl rounded-lg bg-whitefont-semibold text-slate-700 @endif" href="{{ route('promo.index') }}">
                        <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5 @if(Route::is('promo', 'promo.index', 'promo.create', 'promo.show', 'promo.edit')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif">
                ...
                <li class="mt-0.5 w-full">
                    <a aside-nav-link class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors @if(Route::is('link', 'link.index', 'link.create', 'link.show', 'link.edit')) shadow-soft-xl rounded-lg bg-whitefont-semibold text-slate-700 @endif" href="{{ route('link.index') }}">
                        <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5 @if(Route::is('link', 'link.index', 'link.create', 'link.show', 'link.edit')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif">
                ...
                <li class="mt-0.5 w-full">
                    <a aside-nav-link class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors @if(Route::is('bookmaker', 'bookmaker.index', 'bookmaker.create', 'bookmaker.show', 'bookmaker.edit')) shadow-soft-xl rounded-lg bg-whitefont-semibold text-slate-700 @endif" href="{{ route('bookmaker.index') }}">
                        <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5 @if(Route::is('bookmaker', 'bookmaker.index', 'bookmaker.create', 'bookmaker.show', 'bookmaker.edit')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif">
    ...
    <script src="{{asset('/build/assets/js/nav-links.js')}}"></script>
    ...
    <script src="{{asset('/build/assets/js/soft-ui-dashboard-tailwind.js?v=1.0.4')}}" async></script>
    </body>
</html>
