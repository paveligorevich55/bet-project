                        ...
                        <tr>
                            ...
                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <div class="flex px-4 py-1">
                                    <div class="flex flex-col justify-center">
                                        <span class="mb-0 font-semibold leading-normal text-xs">Name</span>
                                        <a href="javascript:void(0);" class="mb-0 leading-light text-xs text-slate-400">https://fasdfasdfasdfasd.com/fasdfasdfasdfasdfasdfasdfasdfasdfasdfasdjkkjjkjkajksfdjkajksdjkf</a>
                                    </div>
                                </div>
                            </td>
