                ...
                <div class="p-0 overflow-x-auto">
                    <table class="items-center px-2 w-full mb-0 align-top border-gray-200 text-slate-500">
                        ...
                        <tr>
                            ...
                            <th class="px-6 py-3 font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">Code
                            ...
                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <div class="flex px-2 py-1">
                                    <div class="flex flex-col justify-center">
                                        <h6 class="mb-0 leading-normal text-sm">{{$promo->name}}</h6>
                                    </div>
                                </div>
                            </td>
                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <div class="flex px-4 py-1">
                                    <div class="flex flex-col justify-center">
                                        <span class="mb-0 font-semibold leading-normal text-xs">Promo</span>
                                        <span class="mb-0 leading-light text-xs text-slate-400">{{$promo->code}}</span>
                                    </div>
                                </div>
                            </td>
                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <div class="flex px-2 py-1">
                                    <div class="flex flex-col justify-center">
                                        <h6 class="mb-0 leading-normal text-sm">{{$promo->bookmaker->name}}</h6>
                                    </div>
                                </div>
                            </td>
                            <td class="p-2 align-middle bg-transparent text-center border-b whitespace-nowrap shadow-transparent">
                                <a href="{{route('promo.edit', [$promo->id])}}" class="font-semibold leading-tight text-xs text-slate-400"> Edit </a>
                            </td>
                            <td class="p-2 align-middle bg-transparent text-center border-b whitespace-nowrap shadow-transparent">
                                <form action="{{route('promo.destroy', [$promo->id])}}" method="post" id="deleteForm">
                                    @method('DELETE')
                                    @csrf
