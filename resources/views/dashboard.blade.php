                            ...
                            <div class="flex-auto p-4">
                                <div class="flex flex-wrap -mx-3">
                                    <div class="flex-none w-2/3 max-w-full px-3">
                                        <div>
                                            <p class="mb-0 font-sans text-sm font-semibold leading-normal dark:opacity-60">Today's Money</p>
                        ...
                        <div class="relative flex flex-col min-w-0 break-words bg-white dark:bg-gray-950 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
                            <div class="flex-auto p-4">
                                <div class="flex flex-wrap -mx-3">
                                    <div class="flex-none w-2/3 max-w-full px-3">
                                        <div>
                                            <p class="mb-0 font-sans text-sm font-semibold leading-normal dark:opacity-60">Today's Users</p>
                                            <h5 class="mb-0 font-bold dark:text-white">
                                                2,300
                        ...
                        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white dark:bg-gray-950 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
                            <div class="flex-auto p-4">
                                <div class="flex flex-wrap -mx-3">
                                    <div class="flex-none w-2/3 max-w-full px-3">
                                        <div>
                                            <p class="mb-0 font-sans text-sm font-semibold leading-normal dark:opacity-60">New Clients</p>
                                            <h5 class="mb-0 font-bold dark:text-white">
                                                +3,462
                        ...
                        <div class="relative flex flex-col min-w-0 break-words bg-white dark:bg-gray-950 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
                            <div class="flex-auto p-4">
                                <div class="flex flex-wrap -mx-3">
                                    <div class="flex-none w-2/3 max-w-full px-3">
                                        <div>
                                            <p class="mb-0 font-sans text-sm font-semibold leading-normal dark:opacity-60">Sales</p>
                                            <h5 class="mb-0 font-bold dark:text-white">
                                                $103,430
                                    ...
                                    <tr>
                                        <td class="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                                            <div class="flex items-center px-2 py-1">
                                                ...
                                                <div class="ml-6">
                                                    <p class="mb-0 text-xs font-semibold leading-tight dark:opacity-60">Country:</p>
                                        ...
                                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap dark:border-white/40">
                                            <div class="text-center">
                                                <p class="mb-0 text-xs font-semibold leading-tight dark:opacity-60">Sales:</p>
                                                <h6 class="mb-0 text-sm leading-normal dark:text-white">2500</h6>
                                            </div>
                                        </td>
                                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap dark:border-white/40">
                                            <div class="text-center">
                                                <p class="mb-0 text-xs font-semibold leading-tight dark:opacity-60">Value:</p>
                                        ...
                                        <td class="p-2 text-sm leading-normal align-middle bg-transparent border-b whitespace-nowrap dark:border-white/40">
                                            <div class="flex-1 text-center">
                                                <p class="mb-0 text-xs font-semibold leading-tight dark:opacity-60">Bounce:</p>
        ...
        <div class="flex flex-wrap mt-6 -mx-3">
            <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
                <div class="relative z-20 flex flex-col min-w-0 break-words bg-white border-0 border-solid dark:bg-gray-950 border-black-125 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
                    <div class="flex-auto p-4">
                        <div class="py-4 pr-1 mb-4 bg-gradient-to-tl from-gray-900 to-slate-800 dark:bg-gradient-to-tl dark:from-slate-850 dark:to-gray-850 rounded-xl">
                            <div>
                                <canvas id="chart-bars" class="chart-canvas" height="170"></canvas>
                            </div>
                        </div>
                        <h6 class="mt-6 mb-0 ml-2 dark:text-white">Active Users</h6>
                        <p class="ml-2 text-sm leading-normal dark:opacity-60">(<span class="font-bold">+23%</span>) than last week</p>
                            ...
                            <div class="flex flex-wrap mt-0 -mx-3">
                                <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                    <div class="flex mb-2">
                                        ...
                                        <p class="mt-1 mb-0 text-xs font-semibold leading-tight dark:opacity-60">Users</p>
                                    </div>
                                ...
                                <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                    <div class="flex mb-2">
                                        ...
                                        <p class="mt-1 mb-0 text-xs font-semibold leading-tight dark:opacity-60">Clicks</p>
                                    </div>
                                ...
                                <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                    <div class="flex mb-2">
                                        ...
                                        <p class="mt-1 mb-0 text-xs font-semibold leading-tight dark:opacity-60">Sales</p>
                                    </div>
                                ...
                                <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                    <div class="flex mb-2">
                                        ...
                                        <p class="mt-1 mb-0 text-xs font-semibold leading-tight dark:opacity-60">Items</p>
                                    </div>
            ...
            <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
                <div class="relative z-20 flex flex-col min-w-0 break-words bg-white border-0 border-solid dark:bg-gray-950 border-black-125 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
                    <div class="p-6 pb-0 mb-0 border-b-0 border-solid border-black-125 rounded-t-2xl">
                        ...
                        <p class="text-sm leading-normal dark:opacity-60">
