...
{{--        <!-- Name -->--}}
{{--        <div>--}}
{{--            <x-panel.input-label for="name" :value="__('Name')" />--}}
{{--            <x-panel.text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />--}}
{{--            <x-panel.input-error :messages="$errors->get('name')" class="mt-2" />--}}
{{--        </div>--}}

{{--        <!-- Email Address -->--}}
{{--        <div class="mt-4">--}}
{{--            <x-panel.input-label for="email" :value="__('Email')" />--}}
{{--            <x-panel.text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" />--}}
...
{{--            <x-panel.text-input id="password" class="block mt-1 w-full"--}}
{{--                            type="password"--}}
{{--                            name="password"--}}
...
{{--        <!-- Confirm Password -->--}}
{{--        <div class="mt-4">--}}
{{--            <x-panel.input-label for="password_confirmation" :value="__('Confirm Password')" />--}}

{{--            <x-panel.text-input id="password_confirmation" class="block mt-1 w-full"--}}
{{--                            type="password"--}}
{{--                            name="password_confirmation" required autocomplete="new-password" />--}}

{{--            <x-panel.input-error :messages="$errors->get('password_confirmation')" class="mt-2" />--}}
{{--        </div>--}}
...
{{--            <x-panel.primary-button class="ml-4">--}}
{{--                {{ __('Register') }}--}}
{{--            </x-panel.primary-button>--}}
{{--        </div>--}}
{{--    </form>--}}

    <div class="pb-56 pt-12 m-4 min-h-50-screen items-start rounded-xl p-0 relative overflow-hidden flex bg-cover bg-center bg-[url('../../assets/img/curved-images/curved6.jpg')]">
    ...
    <div class="container">
        <div class="flex flex-wrap justify-center -mx-3 -mt-48 lg:-mt-48 md:-mt-56">
            <div class="w-full max-w-full px-3 mx-auto shrink-0 md:flex-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
                <div class="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 lg:py-4 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border">
                    ...
                    <div class="flex-auto p-6 text-center">
                        <form role="form text-left" method="post" action="{{route('register')}}">
                            @csrf
                            <div class="mb-4">
                                <x-panel.input-label for="name" :value="__('Name')" class="text-left"/>
                                <x-panel.text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                                <x-panel.input-error :messages="$errors->get('name')" class="mt-2" />
                            </div>
                            <div class="mb-4">
                                <x-panel.input-label for="username" :value="__('Username')" class="text-left"/>
                                <x-panel.text-input id="username" class="block mt-1 w-full" type="text" name="username" :value="old('username')" required autofocus autocomplete="username" />
                                <x-panel.input-error :messages="$errors->get('username')" class="mt-2" />
                            </div>
                            <div class="mb-4">
                                <x-panel.input-label for="email" :value="__('Email')" class="text-left"/>
                                <x-panel.text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="email" />
                                <x-panel.input-error :messages="$errors->get('email')" class="mt-2" />
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <x-panel.input-label for="password_confirmation" :value="__('Confirm Password')" class="text-left"/>
                            ...
                            <div class="min-h-6 pl-7 mb-0.5 block">
                                ...
                                <label class="mb-2 font-normal text-left cursor-pointer select-none -ml-36 text-sm text-slate-700" for="terms"> I agree the <a href="javascript:;" class="font-bold text-slate-700">Terms and Conditions</a> </label>
                            </div>
